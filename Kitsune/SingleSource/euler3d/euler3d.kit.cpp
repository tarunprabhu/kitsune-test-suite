...
static void cpy(float *[[kitsune::mobile]] dst,
                const float *[[kitsune::mobile]] src, int n) {
  // clang-format off
...
static void initialize_variables(int nelr, float *[[kitsune::mobile]] variables,
...
static void compute_flux(int nelr,
  ...
  forall(unsigned blk = 0; blk < nelr / block_length; ++blk) {
    ...
    forall(unsigned int i = b_start; i < b_end; ++i) {
...
static void time_step(int j, int nelr, float *[[kitsune::mobile]] old_variables,
                      float *[[kitsune::mobile]] variables,
                      float *[[kitsune::mobile]] step_factors,
                      float *[[kitsune::mobile]] fluxes) {
  forall(int blk = 0; blk < nelr / block_length; ++blk) {
