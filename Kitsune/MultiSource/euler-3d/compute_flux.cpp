...
void compute_flux(int nelr, const mobile_ptr<int> elements_surrounding_elements,
                  const mobile_ptr<float> normals,
                  const mobile_ptr<float> variables, mobile_ptr<float> fluxes,
